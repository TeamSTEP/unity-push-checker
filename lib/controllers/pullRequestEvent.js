...
exports.handlePullRequest = function (context) { return __awaiter(void 0, void 0, void 0, function () {
    var pr, allFiles, changes, originalDescription, prFullBodyToken, breakFromIndex, upperContent, breakToIndex, lowerContent, commentBody;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                originalDescription = pr.body;
                prFullBodyToken = originalDescription.split('\n');
                breakFromIndex = lodash_1.default.findIndex(prFullBodyToken, '# Unity Project Report') - 1;
                if (breakFromIndex > 0 && prFullBodyToken.length > 0) {
                    upperContent = prFullBodyToken.slice(0, breakFromIndex);
                    breakToIndex = lodash_1.default.findLastIndex(prFullBodyToken, 'End of report') + 1;
                    lowerContent = prFullBodyToken.slice(breakToIndex, prFullBodyToken.length);
                ...
                return [4 /*yield*/, context.github.pulls.update(__assign(__assign({}, pr), { body: originalDescription.concat(commentBody) }))];
            case 2:
                // update the pr description
                _a.sent();
                return [2 /*return*/];
