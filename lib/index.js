...
module.exports = function (app) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        app.on(['pull_request.opened', 'pull_request.reopened', 'pull_request.synchronize'], function (context) {
            try {
                var pr = context.payload.pull_request;
                app.log("Pull request number " + pr.number + " from " + pr.base.repo.owner.login + "/" + pr.base.repo.name + " emitted a new event");
        ...
        app.on('issues.opened', function (context) { return __awaiter(void 0, void 0, void 0, function () {
            var newIssue, pull, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        newIssue = context.payload.issue;
                        app.log("User " + newIssue.user.login + " opened a new issue with the name " + newIssue.title);
                        pull = context.issue();
                        return [4 /*yield*/, context.github.issues.createComment(__assign(__assign({}, pull), { body: 'Hello World!' }))];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
